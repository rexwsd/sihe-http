...
use Sihe\Http\Contracts\Http\Response;
use Sihe\Http\Request\SiheRequest;

class SiheResponse implements Response, Arrayable, \ArrayAccess
{
    ...
    /**
     * SiheResponse 构造函数.
     * @param SiheRequest $request
     * @param ResponseInterface $response
     */
    public function __construct(SiheRequest $request, ResponseInterface $response)
    {
