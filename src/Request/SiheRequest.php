...
use Sihe\Http\Response\SiheResponse;
use Sihe\Http\HttpException;
...
class SiheRequest
{
    ...
    {
        return new SiheResponse($this, $this->buildClient()->request($method, $url, $this->mergeOptions([
